...
public class MainActivity2 extends AppCompatActivity {
    ...
    public class DownloadTask extends AsyncTask<String, String, String>{
        ...
        protected String doInBackground(String... params) {
            ...
            gesture_mapping.put("pet", "25/25066.mp4");
            gesture_mapping.put("sell", "9/9199.mp4");
            gesture_mapping.put("explain", "22/22623.mp4");
            gesture_mapping.put("that", "14/14366.mp4");
            gesture_mapping.put("book", "14/14326.mp4");
            gesture_mapping.put("now", "7/7774.mp4");
            gesture_mapping.put("work", "14/14523.mp4");
            gesture_mapping.put("total", "26/26467.mp4");
            gesture_mapping.put("trip", "9/9117.mp4");
            gesture_mapping.put("future", "14/14736.mp4");
            gesture_mapping.put("good", "21/21534.mp4");
            gesture_mapping.put("thank you", "21/21533.mp4");
            gesture_mapping.put("learn", "21/21560.mp4");
            gesture_mapping.put("agent", "10/10000.mp4");
            gesture_mapping.put("should", "9/9563.mp4");
            gesture_mapping.put("like", "6/6394.mp4");
            gesture_mapping.put("movie", "8/8626.mp4");
